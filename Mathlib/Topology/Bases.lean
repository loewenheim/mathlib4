...
#align topological_space.is_topological_basis IsTopologicalBasis
...
#align topological_space.is_topological_basis.insert_empty IsTopologicalBasis.insert_empty
...
#align topological_space.is_topological_basis.diff_empty IsTopologicalBasis.diff_empty
...
#align topological_space.is_topological_basis_of_subbasis isTopologicalBasis_of_subbasis
...
#align topological_space.is_topological_basis_of_open_of_nhds isTopologicalBasis_of_open_of_nhds
...
theorem IsTopologicalBasis.mem_nhds_iff {a : α} {s : Set α} {b : Set (Set α)}
  ...
  · rcases eq_univ_iff_forall.1 hb.unionₛ_eq a with ⟨i, h1, h2⟩
    exact ⟨i, h2, h1⟩
#align topological_space.is_topological_basis.mem_nhds_iff IsTopologicalBasis.mem_nhds_iff
...
#align topological_space.is_topological_basis.is_open_iff IsTopologicalBasis.isOpen_iff
...
#align topological_space.is_topological_basis.nhds_has_basis IsTopologicalBasis.nhds_hasBasis
...
#align topological_space.is_topological_basis.is_open IsTopologicalBasis.isOpen
...
#align topological_space.is_topological_basis.mem_nhds IsTopologicalBasis.mem_nhds
...
#align topological_space.is_topological_basis.exists_subset_of_mem_open IsTopologicalBasis.exists_subset_of_mem_open
...
#align topological_space.is_topological_basis.open_eq_sUnion' IsTopologicalBasis.open_eq_unionₛ'
...
#align topological_space.is_topological_basis.open_iff_eq_sUnion IsTopologicalBasis.open_iff_eq_unionₛ
...
#align topological_space.is_topological_basis.open_eq_Union IsTopologicalBasis.open_eq_unionᵢ
...
#align topological_space.is_topological_basis.mem_closure_iff IsTopologicalBasis.mem_closure_iff
...
#align topological_space.is_topological_basis.dense_iff IsTopologicalBasis.dense_iff
...
#align topological_space.is_topological_basis.is_open_map_iff IsTopologicalBasis.isOpenMap_iff
...
#align topological_space.is_topological_basis.exists_nonempty_subset IsTopologicalBasis.exists_nonempty_subset

theorem isTopologicalBasis_opens : IsTopologicalBasis { U : Set α | IsOpen U } :=
  isTopologicalBasis_of_open_of_nhds (by tauto) (by tauto)
#align topological_space.is_topological_basis_opens isTopologicalBasis_opens
...
#align topological_space.is_topological_basis.prod IsTopologicalBasis.prod
...
#align topological_space.is_topological_basis.inducing IsTopologicalBasis.inducing
...
#align topological_space.is_topological_basis_of_cover isTopologicalBasis_of_cover
...
#align topological_space.is_topological_basis.continuous IsTopologicalBasis.continuous
...
#align topological_space.separable_space SeparableSpace

theorem exists_countable_dense [SeparableSpace α] : ∃ s : Set α, s.Countable ∧ Dense s :=
  SeparableSpace.exists_countable_dense
#align topological_space.exists_countable_dense exists_countable_dense
...
#align topological_space.exists_dense_seq exists_dense_seq
...
#align topological_space.dense_seq denseSeq
...
#align topological_space.dense_range_dense_seq denseRange_denseSeq
...
#align topological_space.countable.to_separable_space Countable.to_separableSpace

theorem separableSpace_of_denseRange {ι : Type _} [Countable ι] (u : ι → α) (hu : DenseRange u) :
    SeparableSpace α :=
  ⟨⟨range u, countable_range u, hu⟩⟩
#align topological_space.separable_space_of_dense_range separableSpace_of_denseRange

/-- In a separable space, a family of nonempty disjoint open sets is countable. -/
theorem Set.PairwiseDisjoint.countable_of_isOpen [SeparableSpace α] {ι : Type _}
...
#align topological_space.is_separable IsSeparable
...
#align topological_space.is_separable.mono IsSeparable.mono
...
#align topological_space.is_separable.union IsSeparable.union
...
#align topological_space.is_separable.closure IsSeparable.closure
...
#align topological_space.is_separable_Union isSeparable_unionᵢ
...
#align topological_space.is_separable_univ_iff isSeparable_univ_iff
...
#align topological_space.is_separable_of_separable_space isSeparable_of_separableSpace
...
#align topological_space.is_separable.image IsSeparable.image
...
#align topological_space.is_separable_of_separable_space_subtype isSeparable_of_separableSpace_subtype
...
#align topological_space.is_countably_generated_nhds_within isCountablyGenerated_nhdsWithin
...
#align topological_space.is_topological_basis.second_countable_topology IsTopologicalBasis.secondCountableTopology
...
#align topological_space.exists_countable_basis Topology.exists_countable_basis

/-- A countable topological basis of `α`. -/
def countableBasis [SecondCountableTopology α] : Set (Set α) :=
  (exists_countable_basis α).choose
#align topological_space.countable_basis Topology.countableBasis
...
#align topological_space.countable_countable_basis Topology.countable_countableBasis
...
#align topological_space.encodable_countable_basis Topology.encodableCountableBasis

theorem empty_nmem_countableBasis [SecondCountableTopology α] : ∅ ∉ countableBasis α :=
  (exists_countable_basis α).choose_spec.2.1
#align topological_space.empty_nmem_countable_basis Topology.empty_nmem_countableBasis
...
#align topological_space.is_basis_countable_basis Topology.isBasis_countableBasis
...
#align topological_space.eq_generate_from_countable_basis Topology.eq_generateFrom_countableBasis
...
#align topological_space.is_open_of_mem_countable_basis Topology.isOpen_of_mem_countableBasis
...
#align topological_space.nonempty_of_mem_countable_basis Topology.nonempty_of_mem_countableBasis
...
#align topological_space.subtype.second_countable_topology Subtype.secondCountableTopology
...
#align topological_space.is_open_Union_countable isOpen_unionᵢ_countable
...
#align topological_space.is_open_sUnion_countable isOpen_unionₛ_countable
...
#align topological_space.countable_cover_nhds countable_cover_nhds
...
theorem countable_cover_nhdsWithin [SecondCountableTopology α] {f : α → Set α} {s : Set α}
  ...
  exact htU ⟨x, hx⟩
#align topological_space.countable_cover_nhds_within countable_cover_nhdsWithin
...
#align topological_space.is_topological_basis.sigma IsTopologicalBasis.sigma
  ...
  · rintro (x | x) u hxu u_open
    ...
    · obtain ⟨v, vs, xv, vu⟩ : ∃ v, v ∈ t ∧ x ∈ v ∧ v ⊆ Sum.inr ⁻¹' u :=
      ...
      exact ⟨Sum.inr '' v, mem_union_right _ (mem_image_of_mem _ vs), mem_image_of_mem _ xv,
        image_subset_iff.2 vu⟩
#align topological_space.is_topological_basis.sum IsTopologicalBasis.sum
...
#align topological_space.is_topological_basis.quotient_map IsTopologicalBasis.quotientMap
...
#align topological_space.is_topological_basis.quotient IsTopologicalBasis.quotient
...
#align topological_space.quotient.second_countable_topology Quotient.secondCountableTopology
